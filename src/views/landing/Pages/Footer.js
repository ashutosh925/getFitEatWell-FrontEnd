        ...
        <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="col-12 col-lg ml-0 ml-lg-5 pl-0 pl-lg-5 text-center">
                            <ul class="mt-5">
                                <li><a href="#" className="white_text">Pages</a></li>
                                <li><a href="#" className="white_text">Sign up</a></li>
                                <li><a href="#" className="white_text">Login</a></li>
                                <li><a href="#" className="white_text">About Us</a></li>
                                <li><a href="#" className="white_text">Contact Us</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg mt-5 ml-0 ml-lg-5 pl-0 pl-lg-5  text-center">
                                ...
                                <a href="#"><img src={white_appstore} class="white_appstore mt-3" alt="white-appstore" /></a>
